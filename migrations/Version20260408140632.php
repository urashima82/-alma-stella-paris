...
final class Version20260408140632 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_category (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, name_fr VARCHAR(100) NOT NULL, slug VARCHAR(120) NOT NULL, slug_fr VARCHAR(120) NOT NULL, description LONGTEXT DEFAULT NULL, description_fr LONGTEXT DEFAULT NULL, position INT NOT NULL, INDEX IDX_CDFC7356727ACA70 (parent_id), UNIQUE INDEX UNIQ_CDFC7356989D9B62 (slug), UNIQUE INDEX UNIQ_CDFC73564255CF50 (slug_fr), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        // Promotion tables
        $this->addSql('CREATE TABLE promotion (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, name_fr VARCHAR(255) NOT NULL, code VARCHAR(50) DEFAULT NULL, type VARCHAR(30) NOT NULL, discount_type VARCHAR(20) NOT NULL, discount_value NUMERIC(10, 2) NOT NULL, is_active TINYINT NOT NULL DEFAULT 1, is_cumulable TINYINT NOT NULL DEFAULT 0, overrides_compare_at_price TINYINT NOT NULL DEFAULT 0, starts_at DATETIME DEFAULT NULL, ends_at DATETIME DEFAULT NULL, max_usages INT DEFAULT NULL, max_usages_per_email INT DEFAULT NULL, minimum_amount_eur NUMERIC(10, 2) DEFAULT NULL, usage_count INT NOT NULL DEFAULT 0, revenue_generated_eur NUMERIC(12, 2) NOT NULL DEFAULT 0, last_used_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_C11D7DD177153098 (code), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE promotion_usage (id INT AUTO_INCREMENT NOT NULL, promotion_id INT NOT NULL, order_id INT NOT NULL, customer_email VARCHAR(255) NOT NULL, discount_amount_eur NUMERIC(10, 2) NOT NULL, used_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_6D1D7139139DF194 (promotion_id), INDEX IDX_6D1D71398D9F6D38 (order_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
