...
final class Version20260408140632 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_category (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, name_fr VARCHAR(100) NOT NULL, slug VARCHAR(120) NOT NULL, slug_fr VARCHAR(120) NOT NULL, position INT NOT NULL, INDEX IDX_CDFC7356727ACA70 (parent_id), UNIQUE INDEX UNIQ_CDFC7356989D9B62 (slug), UNIQUE INDEX UNIQ_CDFC73564255CF50 (slug_fr), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
