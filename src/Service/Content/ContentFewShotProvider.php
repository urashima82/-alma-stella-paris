 ...
 *
 * Their names carry more weight than any written rule: the model imitates what
 * it is shown far more readily than what it is told. They must therefore all
 * follow the "family word + sub-category word + proper name" shape, and mix
 * first names with place names so neither register looks like the only option.
 * Ravenne/Ravenna is there on purpose: it is the one case where a proper name
 * legitimately differs between the two languages.
 */
final class ContentFewShotProvider
{
    ...
    public function getExamples(): array
    {
        return [
            [
                'category' => 'Bagues > Bagues fines',
                'stones' => 'Pierre de Lune',
                'name_fr' => 'Bague Fine Livia',
                'name_en' => 'Livia Delicate Ring',
            ...
            [
                'category' => 'Boucles d\'oreilles > Boucles dormeuses',
                'stones' => 'Lapis Lazuli',
                'name_fr' => 'Boucles Dormeuses Ostende',
                'name_en' => 'Ostende Sleeper Earrings',
            ...
            [
                'category' => 'Bracelets > Bracelets chaîne',
                'stones' => '',
                'name_fr' => 'Bracelet Chaîne Elsa',
                'name_en' => 'Elsa Chain Bracelet',
            ...
            [
                'category' => 'Colliers > Colliers médaillon pierre',
                'stones' => 'Onyx noir',
                'name_fr' => 'Collier Médaillon Ravenne',
                'name_en' => 'Ravenna Medallion Necklace',
